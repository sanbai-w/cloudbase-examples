    ...
    <div className="container mx-auto px-4 py-12">
      ...
      >
        <div className="bg-gradient-to-r from-orange-400 via-red-500 to-pink-500 rounded-2xl p-8 shadow-2xl">
          <h2 className="text-3xl font-bold text-white mb-4">🍳 胡闹厨房游戏</h2>
          <p className="text-white/90 mb-6">体验基于 Phaser.js 开发的合作烹饪游戏，支持单机和联机模式</p>
          <Link
            to="/overcooked-game"
            className="inline-block bg-white text-orange-600 font-bold py-3 px-8 rounded-xl text-lg hover:bg-gray-100 transition-colors duration-200 shadow-lg transform hover:scale-105"
          >
            🎮 开始游戏
          </Link>
        </div>
